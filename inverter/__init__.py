...
class inverter(rtl, spice, thesdk):
    ...
    def __init__(self, *arg):
        ...
        self.IOS.Members["control_write"] = (
            IO()
        ...
        *arg :
        ...
        if self.model == "py":
            ...
            if self.model in ["sv", "icarus", "verilator"]:
                ...
                self.nproc = 2
                self.spiceoptions = {"eps": "1e-6"}
                self.spiceparameters = {"exampleparam": "0"}
                ...
                _ = spice_dcsource(
                    self, name="ground", value=0, pos="VSS", neg="0"
                )
